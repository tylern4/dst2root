...
class clas12_selector : public TSelector {
 public:
  ...
  TTreeReaderArray<float> torus = {fReader, "torus"};
  TTreeReaderArray<float> solenoid = {fReader, "solenoid"};
  TTreeReaderArray<int> crate = {fReader, "crate"};
  TTreeReaderArray<int> slot = {fReader, "slot"};
  TTreeReaderArray<int> channel = {fReader, "channel"};
  TTreeReaderArray<int> helicity = {fReader, "helicity"};
  TTreeReaderArray<int> quartet = {fReader, "quartet"};
  TTreeReaderArray<int> value = {fReader, "value"};
